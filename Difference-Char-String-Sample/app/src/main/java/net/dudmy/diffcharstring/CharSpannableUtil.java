package net.dudmy.diffcharstring;
...
public class CharSpannableUtil implements SpannableUtil<CharSequence> {

    @Override
    public CharSequence getTextWithIcon(Context context, String text, @DrawableRes int resId) {
